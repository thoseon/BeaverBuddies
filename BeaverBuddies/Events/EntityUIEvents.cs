...
namespace BeaverBuddies.Events
{
    ...
    class WaterInputDepthActionEvent : ReplayEvent
    {
        ...
        public override void Replay(IReplayContext context)
        {
            var waterinput = GetComponent<WaterInputPipeCoordinates>(context, entityID);
            var waterInputSpec = GetComponent<WaterInputPipeSpec>(context, entityID);
    ...
    [HarmonyPatch(typeof(WaterInputPipeDepthFragment), nameof(WaterInputPipeDepthFragment.ToggleDepthLimit))]
    class WaterInputDepthFragmentToggleDepthLimitPatcher
    {
        public static bool Prefix(WaterInputPipeDepthFragment __instance)
        {
            return WaterInputDepthActionEvent.DoPrefix(__instance._waterInputPipeCoordinates, WaterInputDepthAction.ToggleLimit);
        }
    }

    [HarmonyPatch(typeof(WaterInputPipeDepthFragment), nameof(WaterInputPipeDepthFragment.IncreaseDepth))]
    class WaterInputDepthFragmentIncreaseDepthPatcher
    {
        public static bool Prefix(WaterInputPipeDepthFragment __instance)
        {
            return WaterInputDepthActionEvent.DoPrefix(__instance._waterInputPipeCoordinates, WaterInputDepthAction.IncreaseDepthLimit);
        }
    }

    [HarmonyPatch(typeof(WaterInputPipeDepthFragment), nameof(WaterInputPipeDepthFragment.DecreaseDepth))]
    class WaterInputDepthFragmentDecreaseDepthPatcher
    {
        public static bool Prefix(WaterInputPipeDepthFragment __instance)
        {
            return WaterInputDepthActionEvent.DoPrefix(__instance._waterInputPipeCoordinates, WaterInputDepthAction.DecreaseDepthLimit);
        }
    }
