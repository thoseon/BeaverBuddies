...
internal class BloomDropdownProvider : IDropdownProvider, ILoadableSingleton
{
	...
	{
		return _valuesFormatted[_graphicsQualitySettings.BloomEnabled ? 1 : 0];
	}

	public void SetValue(string value)
	{
		_graphicsQualitySettings.ChangeToCustom();
		_graphicsQualitySettings.BloomEnabled = value == _valuesFormatted[1];
	}
