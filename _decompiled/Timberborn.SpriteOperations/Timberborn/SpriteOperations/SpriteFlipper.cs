...
internal class SpriteFlipper : IUnloadableSingleton
{
	...
	private Texture2D CreateFlippedTexture(Sprite original)
	{
		...
		Color32[] pixels = FlipPixels(originalPixelData: texture.GetPixels32(), width: texture.width, height: texture.height);
